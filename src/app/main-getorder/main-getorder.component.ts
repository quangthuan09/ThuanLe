...
@Component({
    selector: "MainGetOrder",
    templateUrl: "./main-getorder.component.html",
    styleUrls: ['./main-getorder.component.css']
})
export class MainGetOrderComponent implements OnInit {
