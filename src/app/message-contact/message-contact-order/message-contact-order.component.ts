...
@Component({
    selector: "MessageContactOder",
    templateUrl: "./message-contact-order.component.html",
    styleUrls: ['./message-contact-order.component.css']
})
export class MessageContactOderComponent implements OnInit {
    public me: String;
