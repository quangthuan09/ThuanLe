...
@Component({
    selector: "MainStatusNumber",
    templateUrl: "./main-statusnumber.component.html",
    styleUrls: ['./main-statusnumber.component.css']
})
export class MainStatusNumberComponent implements OnInit {
